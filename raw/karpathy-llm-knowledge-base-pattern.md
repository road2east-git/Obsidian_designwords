---
title: "Building Personal Knowledge Bases with LLMs"
author: "Andrej Karpathy"
url: "https://gist.github.com/karpathy/442a6bf555914893e9891c11519de94f"
date_clipped: 2026-04-24
type: gist
tags: [LLM, knowledge-management, wiki, RAG, obsidian]
---

# Building Personal Knowledge Bases with LLMs
...
**Lint.** Periodically, ask the LLM to health-check the wiki. Look for: contradictions between pages, stale claims, orphan pages, missing cross-references.
...
## Optional: CLI tools
At some point you may want to build small tools. qmd is a good option for search.

## Tips and tricks
- Obsidian Web Clipper for clipping articles
- Download images locally
- Obsidian's graph view for wiki shape
